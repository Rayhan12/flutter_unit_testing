...
1. 🧪 [Test Driven Development](#test-driven-development-tdd-cycle)
   - 🔴 [Red](#-1-red--write-a-failing-test)
   - 🟢 [Green](#-2-green--make-the-test-pass)
   - ♻️ [Refactor](#️-3-refactor--clean-the-code)
...
4. 🧭 [Arrange Act Assert (AAA) Pattern](#arrangeactassert-aaa-pattern)
   - 🛠️ [Arrange](#-1-arrange)
   - ▶️ [Act](#-2-act)
   - ✅ [Assert](#-3-assert)
